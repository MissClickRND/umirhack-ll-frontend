...
import { Stack, Paper, rem, Title, TextInput, Group, Button, Text } from "@mantine/core";
...
export default function SearchDiploma() {
    ...
    return (
        <Stack w={'100%'}>
            <Paper p={32} radius="lg" shadow="sm" withBorder>
                <Stack gap={24}>
                    <Stack align="center" gap={8} mb={20}>
                        <Title ta="center" order={2} size="h2" fw={700}>
                            Проверка диплома
                        </Title>
                        <Text ta={"center"} size="sm" c="dimmed" px={20}>
                            Проверка подлинности документов об образовании по единой базе выпускников.
                        </Text>
                    </Stack>
