...
import { IUserPublic, UserRole, useGetUsersQuery, useUpdateRoleUserMutation } from "@/entities/user";
...
const roleOptions: Array<{ value: UserRole; label: string }> = [
    ...
    { value: "NEED_VERIFICATION", label: "NEED_VERIFICATION" },
];
    ...
    const handleChangeRole = async (user: IUserPublic) => {
        ...
        try {
            ...
            notifications.show({
                ...
                message: `${user.email}: ${user.role} -> ${nextRole}`,
                color: "green",
            });
        } catch {
            notifications.show({
                                ...
                                <Stack gap={10}>
                                    ...
                                    <Group justify="space-between" align="center">
                                        <Box>
                                            ...
                                            <Badge variant="light" color={roleLabelColor[user.role]}>
                                                {user.role}
                                            </Badge>
                                        </Box>
                                        <Text size="xs" c="dimmed">
